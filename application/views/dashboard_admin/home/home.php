...
<html lang="en">
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Data Customer</a>
		  <div class="nav-collapse">
		  <ul class="nav">
			  <li><a href="<?php echo base_url(); ?>customer/tambah" class="medium-box"><i class="icon-plus-sign icon-white"></i> Add New Customer</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?php echo form_open("dashboard_admin/cari", 'class="navbar-form pull-right"'); ?>
		  <input type="text" class="span3" name="cari" placeholder="Masukkan customer name">
		  <button type="submit" class="btn btn-primary"><i class="icon-search icon-white"></i> Find Customer</button>
		<?php echo form_close(); ?>
		</div>
		</div>
	  </div><!-- /navbar-inner -->
  ...
  <table class="table table-hover table-condensed">
	...
	?>
      <tr>
        <td><?php echo $no; ?></td>
        <td><?php echo $dp['Cust_Name']; ?></td>
        <td><?php echo $dp['Product']; ?></td>
        <td><?php echo $dp['AM_Name']; ?></td>
        <td><?php echo $dp['Keterangan']; ?></td>
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small" href="<?php echo base_url(); ?>customer/detail/<?php echo $dp['id_customer']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo base_url(); ?>customer/edit/<?php echo $dp['id_customer']; ?>"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?php echo base_url(); ?>customer/hapus/<?php echo $dp['id_customer']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
