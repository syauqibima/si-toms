		  ...
		  <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="<?php echo base_url(); ?>master_ppk"><i class="icon-eye-open"></i> Account Manager</a></li>
                  <li><a href="<?php echo base_url(); ?>master_hukuman"><i class="icon-briefcase"></i> Product</a></li>
				  <li><a href="<?php echo base_url(); ?>master_status_jabatan"><i class="icon-tasks"></i> Status</a></li>
                </ul>
              </li>
			  <li class="dropdown">
