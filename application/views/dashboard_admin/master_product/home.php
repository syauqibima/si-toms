...
<html lang="en">
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Master Product</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>master_product/tambah" class="small-box"><i class="icon-plus-sign icon-white"></i> Add New Product</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?php echo form_open('master_product/cari','class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	<?php
		$no=$tot+1;
		foreach($data_product->result_array() as $dp)
		{
	?>
      <tr>
        <td><?php echo $no; ?></td>
        <td><?php echo $dp['Product']; ?></td>
        <td><?php echo $dp['Kind']; ?></td>
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small small-box" href="<?php echo base_url(); ?>master_product/detail/<?php echo $dp['id_product']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo base_url(); ?>master_product/edit/<?php echo $dp['id_product']; ?>" class="small-box"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?php echo base_url(); ?>master_product/hapus/<?php echo $dp['id_product']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
